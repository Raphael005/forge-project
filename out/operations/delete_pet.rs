...
impl runtime::Operation for DeletePet {
        ...
        B::Error: Into<Box<dyn std::error::Error + Send + Sync + 'static>>,
    {
        ...
        match parts.status.as_u16() {
            204 => Ok(DeletePetOutput::NoContent),
            404 => Ok(DeletePetOutput::NotFound),
            status => {
